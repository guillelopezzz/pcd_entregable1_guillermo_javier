...
class Admin:
    def __init__(self, id_cuenta):
        ...
        self.matriculas = [] # asignaturas de cada estudiante
        self.docencia = [] # asignaturas de cada profesor
    ...
    def crear_profesor(self, nombre, dni, direccion, sexo, tipo):
        ...
        if tipo.lower() == "asociado":
            ...
            investigador = Investigador(profesor, area)
    ...
    def cambiar_departamento(self, dni, nuevo_departamento): # cambiar la instancia
